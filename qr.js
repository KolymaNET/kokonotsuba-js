	...
	openqr: function () {
		...
		with (pf) {
			...
			if (typeof(sub)!='undefined') {
				qr.innerHTML+= '<div id="qrsubdiv"><input type="text" name="sub" id="qrsub" size="28" value="'+sub.value+'" maxlength="100" class="inputtext" placeholder="Subject" oninput="kkqr.input(this);"/></div>';
			...
			if (typeof(category)!='undefined')
				kkqr.win.div.innerHTML+= '<div><input type="text" name="category" id="qrcategory" size="28" value="'+category.value+'" class="inputtext" placeholder="Category" oninput="kkqr.input(this);" /> <small>(Use , to separate)</small></div>';
